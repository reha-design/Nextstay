...
**Nextstay** 는 고성능 비동기 처리와 현대적인 MSA 기반 아키텍처를 실무적으로 구현한 숙박 예약 시스템입니다. Kotlin(Spring Boot), Bun(Elysia.js), Nuxt 3 등 각 도메인에 최적화된 기술 스택을 활용하여 확장성과 사용자 경험을 극대화했습니다.
